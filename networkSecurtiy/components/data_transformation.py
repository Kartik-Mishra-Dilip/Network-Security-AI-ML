...
from networkSecurtiy.constant.training_pipeline import TARGET_COLUMN
from networkSecurtiy.constant.training_pipeline import DATA_TRANSFORMATION_IMPUTER_PARAMS
from networkSecurtiy.entity.artifact_enitiy import DataTransformationArtifact,DataValidationArtifact
from networkSecurtiy.entity.config_entity import DataTransformationConfig
...
from networkSecurtiy.utils.main_utils.utils import save_numpy_array_data,save_object
...
class DataTransformation:
    ...
    def get_data_transformer_object(cls) -> Pipeline:
        logging.info("enter get data transformer objext method of transformation class")
        try:
            imputer:KNNImputer=KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)
            logging.info(f"initiatilze  knnimputer with {DATA_TRANSFORMATION_IMPUTER_PARAMS}")
